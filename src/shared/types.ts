...
export type ClientMessage =
  | { type: "draft:start" }
  | { type: "draft:ban-map"; mapId: string }
  | { type: "draft:pick-map"; mapId: string }
  | { type: "draft:select"; characterId: string }
  | { type: "draft:lock" };

export type ServerMessage =
  | { type: "room:state"; state: RoomState }
  | { type: "draft:state"; state: DraftState }
  | { type: "draft:timer"; remaining: number }
  | { type: "draft:phase-change"; phase: DraftPhase }
  | { type: "draft:action"; action: DraftAction }
