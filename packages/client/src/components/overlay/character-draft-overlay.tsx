...
/**
 * Groups turn order steps into display groups for the overlay.
 * E.g. for snake+staggered+1ban+3picks:
 *   "Ban Phase" (2 steps), "Pick 1" (1), "Pick 2/3" (2), "Pick 4/5" (2), "Pick 6" (1)
 */
...
function getCharacterIdForStep(
  ...
  if (step.type === "ban") {
    ...
    // Machine stores null for "no ban", a string for a real ban
    ...
    <div className="flex items-center gap-5">
      ...
      {selectedMap && (
        <div className="flex items-center gap-3 shrink-0">
          ...
          {/* Awakenings — vertical, icons only */}
          {awakenings.length > 0 && (
      ...
      {/* Right section: Character portraits by phase group */}
